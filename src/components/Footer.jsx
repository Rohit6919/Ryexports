            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <p class="text-base leading-relaxed text-gray-600">RY Exports is committed to delivering high-quality export and import solutions with reliability and trust.
                            We ensure smooth global trade through premium sourcing, secure logistics, and transparent processes.</p>
                ...
                <p class="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by RyExport</p>
            </div>
        </section>
