    ...
    return (
        <>
            <section id="hero" className="relative overflow-hidden ">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 lg:py-12 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        >
                            ...
                            <p className="mt-4 w-full lg:max-w-xl mx-auto lg:mx-0 text-lg md:text-xl text-gray-600 font-medium leading-relaxed">
                            ...
                            {/* Feature row */}
                            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full lg:max-w-xl mx-auto lg:mx-0">
